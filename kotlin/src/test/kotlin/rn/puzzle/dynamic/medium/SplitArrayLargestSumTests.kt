...
class SplitArrayLargestSumTests {
    ...
    @Test
    fun test1() {
        solve(intArrayOf(7,2,5,10,8), 2, 18)
    }

    @Test
    fun test2() {
        solve(intArrayOf(1,2,3,4,5), 2, 9)
        solve(intArrayOf(1,2,3,4,5), 3, 6)
        solve(intArrayOf(1,2,3,4,5), 4, 5)

        solve(intArrayOf(1,2,3,4,5,6), 2, 11)
        solve(intArrayOf(1,2,3,4,5,6), 3, 9)
        solve(intArrayOf(1,2,3,4,5,6), 4, 6)

        solve(intArrayOf(1,2,3,4,5,6,7), 2, 15)
        solve(intArrayOf(1,2,3,4,5,6,7), 3, 11)
    }
}