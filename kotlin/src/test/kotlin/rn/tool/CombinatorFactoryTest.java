...
public class CombinatorFactoryTest {

    @Test
    public void combinator_3_2() {
        ICombinator combinator = rn.tool.combination.CombinatorFactory.create(3, 2);
    ...
    public void variant_length() {
        ICombinator combinator = rn.tool.combination.CombinatorFactory.variantLength(3);
